    ...
    const captureAndSend = useCallback(async () => {
        if (webcamRef.current && cameraStates) {
            ...
            try {
                ...
                if (selectedMonHoc && sinhVienDky.includes(qrCodedetech)) {
                    setSuccessMessage(`Quét thành công cho sinh viên: ${qrCodedetech}`);
                    ...
                    setErrorMessage(`Sinh viên ${qrCodedetech} không đăng ký môn học này.`);
                }
            } catch (error) {
